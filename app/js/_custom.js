...
function Spoiler(){
  let myspeed = 1000;
  let itemHeight = $('.section-events_according .the-css-at-table').height();
  $('.section-events_according .the-css-at-table').css('height','124');

$('.section-events_according .btn--look_down').click(
    function() {
      $('.section-events_according .the-css-at-table').animate({height:itemHeight}, myspeed);
   $('.section-events_according').toggleClass('active-button');
 
    });


$('.section-events_according .btn--look_up').click(
    function() {
      $('.the-css-at-table').animate({height:124}, myspeed);
   $('.section-events').toggleClass('active-button');
    setTimeout(function(){
      var scrollTop = $('.the-css-at-table').offset().top-100;
